...
#常量
MOVIE_LIST_FILE = "data/movie.csv"
...
# 获取电影上映时间
def get_movie_publish_data(movie_datas):
    movie_data =  movie_datas[0].strip() if movie_datas else ''
    return re.search(r'(\d{4}-\d{2}-\d{2})', movie_data).group(1)
...
def get_movie_info(movie_info_url):
    ...
    movie_years = movie_doc.xpath("//*[@id='original_header']/div[2]/section/div[1]/h2/span[contains(@class,'release_date')]/text()") #上映年份
    movie_datas = movie_doc.xpath("//*[@id='original_header']/div[2]/section/div[1]/div/span[@class='release']/text()") #上映时间
    ...
    movie_languages = movie_doc.xpath("//*[@id='media_v4']/div/div/div[2]/div/section/div[1]/div/section[1]/p[contains(., '语言')]/text()") #语言
    movie_directors = movie_doc.xpath("//*[@id='original_header']/div[2]/section/div[3]/ol/li[2]/p[1]/a/text()") #导演
    movie_authors = movie_doc.xpath("//*[@id='original_header']/div[2]/section/div[3]/ol/li[4]/p[1]/a/text()") #作者
    ...
    movie_info = {
        ...
        "年份": get_movie_year(movie_years) if movie_years else '',
        "上映时间": get_movie_publish_data(movie_datas) if movie_datas else '',
        "类型": ",".join(movie_tags) if movie_tags else '',
        "时长": get_movie_cost_time(movie_cost_times) if movie_cost_times else '',
